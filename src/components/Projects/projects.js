...
export const ProjectCard = () => {
  return (
    <div className="images-container portfolio-page">
        <h1>
        <Typewriter text="Portfolio"delay={100} /> </h1>
      <div className='text-zone'>
        <h2>
          I take pride in my ability to seamlessly integrate my expertise as an
          oncology nurse with my skills as a full-stack software engineer.
